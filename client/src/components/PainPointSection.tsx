...
export function PainPointSection() {
  return (
    <section className="container py-16 md:py-24">
        ...
        <div className="flex gap-4 md:gap-6 items-start">
          ...
          <div>
            ...
            <p className="text-base md:text-lg text-red-800 leading-relaxed mb-4">
              不是単一項目費用高，而是物料、包裝、機器設備、人力成本全部一起拉高，且機器設備沒有發揮效能（如印表機、投影機、錄音筆），導致人力成本進一步提高。
            </p>
            <p className="text-base md:text-lg text-red-800 leading-relaxed">
              目前的營運模式像「日式無菜單料理」，每顆達克瓦茲都需要 8 分鐘的職人工時。當客戶購買一盒 (6 顆) 時，製作時間就變得可怕。
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-12">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-md border-l-4 border-yellow-500">
          <div className="flex items-start gap-4 mb-4">
            ...
            <h4 className="text-xl font-bold text-gray-900">機器設備沒效能</h4>
          </div>
          <p className="text-gray-600 leading-relaxed">
            高規格設備 (印表機、投影機、錄音筆) 的隱形成本持續累積，拉高營運標準，卻未必發揮應有效能。
          </p>
        </div>
      </div>
      ...
      {/* Comparison Slider */}
      <div className="mb-12">
        <h3 className="text-2xl font-bold text-gray-900 mb-8">現況 vs 目標：營運模式的轉變</h3>
